...
function funcTest() {
  ...
  return "Hello from Function Declaration" + int2 + int1;
}

//console.log(annonFunc());
...
document.querySelector("#hello").textContent =
  "with 2 id with same names, only 1st one will take effect from JS";
// in js, cannot create a var after method and use in method before
